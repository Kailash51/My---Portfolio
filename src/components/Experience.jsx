...
import Power from '../assets/experience/Power b.png'
import flutter from '../assets/experience/flutter.png'
import SQL from '../assets/experience/SQL img.png'
...
const Experience = () => {
    ...
    return (
        <div name="skills" className='py-10 bg-gradient-to-b from-gray-800 to-black text-white
     w-full h-full' >
